...
urlpatterns = [
    ...
    path('api/v1/text_to_text/', TextToTexTOpeniaiView.as_view(), name="TextToTexTOpeniaiView"),
    path('api/v1/text_to_image/', TextToImageView.as_view(), name="TextToImagesAPI"),
    path('api/v1/taobao/', GetTaobaoItems.as_view(), name="GetTaobaoItems"),
    path('api/v1/currencies/', GetCurrencies.as_view(), name="GetCurrencies"),
    ...
    path("api/v2/community/items/", CommunityItems.as_view(), name="CommunityItems"),
