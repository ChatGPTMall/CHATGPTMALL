"""
Django settings for chatgptmall project.
...
SECRET_KEY = 'django-insecure-2yl_t9_+&$h^$nxpaj74=0wr7$=23yml)*)ci3poqp(@zhdhed'
...
WSGI_APPLICATION = 'chatgptmall.wsgi.application'
...
JAZZMIN_SETTINGS = {
    ...
    "site_title": "CHATGPTMALL Admin",

    # Title on the login screen (19 chars max) (defaults to current_admin_site.site_header if absent or None)
    "site_header": "CHATGPTMALL",

    # Title on the brand (19 chars max) (defaults to current_admin_site.site_header if absent or None)
    "site_brand": "CHATGPTMALL",
    ...
    "welcome_sign": "CHATGPTMALL Admin Area",

    # Copyright on the footer
    "copyright": "CHATGPTMALL Ltd",
...
EMAIL_HOST_USER = 'no.reply.homelinked@gmail.com'
EMAIL_HOST_PASSWORD = 'skfpulasrieegujr'
EMAIL_PORT = 587
EMAIL_USE_TLS = True
EMAIL_USE_SSL = False
